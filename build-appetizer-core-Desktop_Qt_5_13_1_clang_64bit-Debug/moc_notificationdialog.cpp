...
#include <memory>
#include "../appetizer-core/notificationdialog.h"
...
QT_MOC_LITERAL(1, 19, 18), // "reverseAnimStarted"
QT_MOC_LITERAL(2, 38, 0) // ""

    },
    "NotificationDialog\0reverseAnimStarted\0"
    ""
};
...
void NotificationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NotificationDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reverseAnimStarted(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NotificationDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NotificationDialog::reverseAnimStarted)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject NotificationDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_NotificationDialog.data,
    qt_meta_data_NotificationDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void NotificationDialog::reverseAnimStarted()
{
